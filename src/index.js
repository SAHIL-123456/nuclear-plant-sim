  ...
  <script>
    ...
    function updateDashboard(data) {
      ...
      if (data.safety) {
        ...
        alarmsDiv.innerHTML = '';
        if (data.safety.alarms && data.safety.alarms.length > 0) {
